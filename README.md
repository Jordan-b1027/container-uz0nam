...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uz0nam.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uz0nam.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jordan-b1027/container-uz0nam.git
cd container-uz0nam
```
...
```
docker attach container-uz0nam
```
